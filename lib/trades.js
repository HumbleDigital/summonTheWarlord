...
import { SwapError, formatSwapExecutionError } from "./errors.js";
    ...
    if (!txid) {
      if (notificationsEnabled) {
        notify({
          ...
          message: formatSwapExecutionError(err) || "Swap failed during execution.",
          sound: "Basso",
        });
      }
      throw new SwapError(`Swap failed: ${formatSwapExecutionError(err)}`, { cause: err });
    }
  }
