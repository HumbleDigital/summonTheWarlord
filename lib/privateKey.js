...
/**
 * Returns a Uint8Array secretKey suitable for Keypair.fromSecretKey.
 * Do not wipe this buffer after fromSecretKey: web3.js retains the same
 * Uint8Array reference on Keypair.secretKey (no copy). Wipe only temporary
 * buffers that are not handed to a live Keypair (e.g. validation).
 */
